      ...
      <section className="bg-warm-50 border-t border-warm-200 py-10">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-serif text-2xl font-semibold text-accent mb-3">
            Chongqing & Chengdu Discovery Tour
          </h2>
          <p className="text-gray-600 mb-6 max-w-xl mx-auto">
            Explore central China's cultural heartland with its stunning natural beauty, ancient temples, and warm local hospitality. A hidden gem for New Zealand adventurers seeking authentic experiences away from crowds.
          </p>
          <a
            href="/tours/chongqing-chengdu"
            className="inline-block bg-primary text-white font-semibold px-6 py-3 rounded-lg hover:opacity-90 transition"
          >
            View Chongqing & Chengdu Tours →
          </a>
        </div>
      </section>
    </>
