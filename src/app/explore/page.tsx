...
const destinations = [
  ...
  { id: 5, slug: 'guilin', name: 'Guilin', description: 'Famous for its karst mountains and Li River scenery', image_url: 'https://qbturrydultenhlfmdcm.supabase.co/storage/v1/object/public/tour-images/guilin-river-valley.jpg' },
