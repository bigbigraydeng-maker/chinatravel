...
const slug = 'forbidden-city-travel-guide';
...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'website', url: '/forbidden-city-travel-guide' },
  alternates: { canonical: '/forbidden-city-travel-guide' },
};

export default function GuidePage() {
  const guide = getGuideBySlug('forbidden-city-travel-guide');
