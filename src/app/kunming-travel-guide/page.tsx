      ...
      <section className="bg-warm-50 border-t border-warm-200 py-10">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-serif text-2xl font-semibold text-accent mb-3">
            Start Your Yunnan Adventure in Kunming
          </h2>
          <p className="text-gray-600 mb-6 max-w-xl mx-auto">
            CTS Yunnan tours start in Kunming — gateway to the Stone Forest, Dian Lake, and onward to Dali and Lijiang. NZD pricing, Auckland team.
          </p>
          <a
            href="/yunnan-tours"
