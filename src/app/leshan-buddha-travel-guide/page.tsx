...
const slug = 'leshan-buddha-travel-guide';
...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'website', url: '/leshan-buddha-travel-guide' },
  alternates: { canonical: '/leshan-buddha-travel-guide' },
};

export default function GuidePage() {
  const guide = getGuideBySlug('leshan-buddha-travel-guide');
