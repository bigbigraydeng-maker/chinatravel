      ...
      <section className="bg-warm-50 border-t border-warm-200 py-10">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-serif text-2xl font-semibold text-accent mb-3">
            Explore Lijiang on a Yunnan Tour
          </h2>
          <p className="text-gray-600 mb-6 max-w-xl mx-auto">
            Lijiang Old Town is a highlight of every CTS Yunnan itinerary — cobblestone lanes, Naxi culture, and views of Jade Dragon Snow Mountain.
          </p>
          <a
            href="/yunnan-tours"
