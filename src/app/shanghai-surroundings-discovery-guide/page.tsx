      ...
      <section className="bg-warm-50 border-t border-warm-200 py-10">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-serif text-2xl font-semibold text-accent mb-3">
            Shanghai & Surroundings Discovery Tour
          </h2>
          <p className="text-gray-600 mb-6 max-w-xl mx-auto">
            Discover the dynamic energy of modern Shanghai and the classical beauty of Jiangnan's ancient water towns. A perfect blend of contemporary China and timeless traditions for New Zealand travellers.
          </p>
          <a
            href="/tours/shanghai-surroundings"
