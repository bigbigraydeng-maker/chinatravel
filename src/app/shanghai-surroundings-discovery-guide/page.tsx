      ...
      <article className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="mb-10 rounded-xl overflow-hidden">
            ...
            <img
              src="/images/tours/suzhou-canal.jpg"
              alt="Classical canal scene in Suzhou, Jiangnan region"
      ...
      <section className="bg-emerald-50 border-t border-emerald-200 py-10">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-700 mb-6 max-w-xl mx-auto">
            Combine Shanghai's urban attractions with Suzhou's classical gardens and explore charming water towns across the Jiangnan region.
          </p>
          <a
      ...
      <section className="bg-warm-50 border-t border-warm-200 py-10">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-serif text-2xl font-semibold text-accent mb-3">
            Explore Shanghai & Jiangnan on a China Tour
          </h2>
          <p className="text-gray-600 mb-6 max-w-xl mx-auto">
            Shanghai and Jiangnan's classical gardens, serene lakes, and water towns are highlights of our curated multi-city tours. Perfect for discerning NZ travellers. From NZD $2,999.
          </p>
          <a
          ...
          >
            View Shanghai & Surroundings Tour →
          </a>
        </div>
      </section>
    </>
