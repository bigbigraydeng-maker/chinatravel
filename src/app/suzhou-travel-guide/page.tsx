...
const slug = 'suzhou-travel-guide';
...
export const metadata: Metadata = {
  ...
  openGraph: { type: 'website', url: '/suzhou-travel-guide' },
  alternates: { canonical: '/suzhou-travel-guide' },
};

export default function GuidePage() {
  const guide = getGuideBySlug('suzhou-travel-guide');
