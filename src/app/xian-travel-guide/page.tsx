      ...
      <section className="bg-blue-50 border-t border-blue-200 py-10">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-700 mb-6 max-w-xl mx-auto">
            Combine Xi'an's terracotta warriors with Beijing's imperial heritage. Our carefully curated Beijing & Xi'an discovery packages connect China's two most iconic destinations.
          </p>
          <a
      ...
      <section className="bg-warm-50 border-t border-warm-200 py-10">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-serif text-2xl font-semibold text-accent mb-3">
            Book an Xi'an Tour from New Zealand
          </h2>
          <p className="text-gray-600 mb-6 max-w-xl mx-auto">
            CTS Tours offers Xi'an packages covering the Terracotta Warriors, Ancient City Wall, and Muslim Quarter — designed for NZ travellers.
          </p>
          <a
            href="/xian-tours"
