      ...
      <section className="bg-warm-50 border-t border-warm-200 py-10">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-serif text-2xl font-semibold text-accent mb-3">
            Explore Yangshuo on a Guilin Tour
          </h2>
          <p className="text-gray-600 mb-6 max-w-xl mx-auto">
            CTS Tours includes free time in Yangshuo on every Guilin itinerary — cycle the countryside, take a bamboo raft, or simply explore West Street.
          </p>
          <a
            href="/guilin-tours"
