...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-accent to-dark text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="mb-4">
              <Image src="/logo.png" alt="CTS Tours" width={180} height={48} className="h-12 w-auto bg-white rounded px-2 py-1" />
            </div>
            <p className="text-gray-400 mb-4">China Travel Specialists for New Zealanders</p>
            <p className="text-gray-400 text-sm mb-6">98 Years Heritage | Direct China Operations | Authentic Access</p>
            {/* Social Media */}
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-400">
              <a href="mailto:ctstours1@chinatravel.co.nz" className="flex items-start gap-2 hover:text-white transition-colors">
                <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                ctstours1@chinatravel.co.nz
              </a>
              <a href="tel:0800287888" className="flex items-start gap-2 hover:text-white transition-colors">
                <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                0800 CTS 888 (0800 287 888)
              </a>
              <p className="flex items-start gap-2">
                ...
                2F CTS House, 175 Queen Street, Auckland
              </p>
            </div>
          </div>
        </div>
