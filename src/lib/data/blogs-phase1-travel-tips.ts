...
## How I think about packing from New Zealand
...
### Beat the heat sensibly

- **High-SPF sunscreen**, **polarised sunglasses**, **wide-brim hat**
- **Reusable water bottle** and **electrolyte sachets** if you are not used to heat
- **Light scarf or jumper** for air-conditioned buses and hotels

## Autumn (September–November): The sweet spot for many routes
...
**DiDi** is China’s dominant ride-hailing platform — comparable to Uber. Since 2023, DiDi has improved its **international-facing** experience for visitors. In major cities (Beijing, Shanghai, Chengdu, Xi’an, Guilin, Hangzhou), DiDi works reliably for airport runs, hotel transfers, and evening outings when you are not on a coach transfer I have booked.
...
- The app offers an **English-language interface** and shows fares upfront in CNY

### Practical tips for NZ travellers

- Type your **destination in English** — the app often maps it automatically
- **Express** (快车) is the standard affordable option; **Premier** can suit airport runs with luggage
- Share your **trip status** with a travel companion for peace of mind
- On my **Discovery** and **Signature** tours, guides handle core transfers — DiDi is most useful for **free evenings** and personal excursions
- As a fallback, **Amap** (Gaode Maps) has a built-in ride-hailing flow that integrates with multiple providers including DiDi
...
Pleasant **April–May** and **September–October**; harsh mid-winter cold; summer storms possible. Good match for [A Tale of Two Cities–style](/tours/china/discovery/beijing-xian) loops if you want Wall plus Terracotta without melting.

### Shanghai, Suzhou, Hangzhou

**Humid summers**; **late autumn foliage** is lovely. Pairs with [Jiangnan Discovery](/tours/china/discovery/shanghai-surroundings) pacing.

### Guilin, Yangshuo, Li River

Misty spring; busy summer; photographers often prefer **May–June** and **September**. See [Guilin guide](/guide/guilin-travel-guide).
...
**Ethnic festivals** and **lantern dates** vary by lunar calendar — tell me if you want lantern markets or **minority New Year** experiences. For camera-focused trips, read my [photography hidden gems](/blog/photography-guide-china-best-locations-hidden-gems) companion post.
...
**Mist after rain** simplifies backgrounds; manage **polariser** carefully for water glare. See [Guilin](/guide/guilin-travel-guide) for seasonal mist patterns.
...
Photographers often combine **Guilin and Zhangjiajie** with a **Yangtze segment** — explore [China Signature](/tours/china/signature) pacing or ask for a **Discovery** overview loop on the [China tours hub](/china-tours).
