...
export const shanghaiGuide: DestinationGuide = {
  ...
  metaDescription: 'Discover Shanghai\'s iconic waterfront: The Bund, Yu Garden, French Concession & Pudong skyline. Expert travel guide for New Zealand visitors to Asia\'s most cosmopolitan city.',
...
export const chengduGuide: DestinationGuide = {
  ...
  metaDescription: 'Discover Chengdu\'s highlights: Giant Panda Base, Wenshu Temple, Sichuan hotpot & Jinli Street. Expert travel guide for New Zealand visitors to southwest China\'s vibrant capital.',
