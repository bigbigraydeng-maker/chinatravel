...
export const chengduGuide: DestinationGuide = {
  ...
  heroImage: 'https://qbturrydultenhlfmdcm.supabase.co/storage/v1/object/public/guide-images/guides/chengdu/hero/hero.jpg',
  introText: [
...
export const guilinGuide: DestinationGuide = {
  ...
  heroImage: 'https://qbturrydultenhlfmdcm.supabase.co/storage/v1/object/public/guide-images/guides/guilin/hero/hero.jpg',
  introText: [
