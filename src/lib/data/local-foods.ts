...
export interface LocalFood {
  ...
  imageUrl: string; // Supabase Storage (migrated from Unsplash)
...
export const localFoods: LocalFood[] = [
  // Beijing
  {
    ...
    imageUrl: migratedUnsplash('photo-1569949381669-ecf31ae8e613'),
  ...
  },
  {
    ...
    imageUrl: migratedUnsplash('photo-1544025162-d76694265947'),
  ...
  },
  {
    ...
    imageUrl: migratedUnsplash('photo-1607623814075-e51df1bdc82f'),
  ...
  },
  {
    ...
    imageUrl: migratedUnsplash('photo-1559827260-dc66d52bef19'),
