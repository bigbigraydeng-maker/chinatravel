const VERIFIED_IMAGE_IDS = new Set([
  'beijing-001', 'beijing-002', 'beijing-003', 'beijing-004', 'beijing-005',
  'shanghai-001', 'shanghai-002', 'shanghai-003', 'shanghai-004',
  'xian-001', 'xian-002', 'xian-003',
  'chengdu-001', 'chengdu-002', 'chengdu-003',
  'hangzhou-001', 'hangzhou-002', 'hangzhou-003',
  'guilin-001', 'guilin-002',
  'chongqing-001', 'chongqing-002',
  'yunnan-001', 'yunnan-002', 'yunnan-003',
  'suzhou-001', 'yangshuo-001',
]);

export function getLocalFoodImage(id: string): string {
  return VERIFIED_IMAGE_IDS.has(id) ? `/images/food-guide/${id}.webp` : '';
}
...
export interface LocalFood {
  ...
  imageUrl: string; // Verified dish photo, or empty while a suitable image is curated
...
export const localFoods: LocalFood[] = [
  // Beijing
  {
    ...
    imageUrl: getLocalFoodImage('beijing-001'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('beijing-002'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('beijing-003'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('beijing-004'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('beijing-005'),
  ...
  // Shanghai
  {
    ...
    imageUrl: getLocalFoodImage('shanghai-001'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('shanghai-002'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('shanghai-003'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('shanghai-004'),
  ...
  // Xi'an
  {
    ...
    imageUrl: getLocalFoodImage('xian-001'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('xian-002'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('xian-003'),
  ...
  // Chengdu
  {
    ...
    imageUrl: getLocalFoodImage('chengdu-001'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('chengdu-002'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('chengdu-003'),
  ...
  // Hangzhou
  {
    ...
    imageUrl: getLocalFoodImage('hangzhou-001'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('hangzhou-002'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('hangzhou-003'),
  ...
  // Guilin
  {
    ...
    imageUrl: getLocalFoodImage('guilin-001'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('guilin-002'),
  ...
  // Chongqing
  {
    ...
    imageUrl: getLocalFoodImage('chongqing-001'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('chongqing-002'),
  ...
  // Yunnan
  {
    ...
    imageUrl: getLocalFoodImage('yunnan-001'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('yunnan-002'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('yunnan-003'),
  ...
  // Suzhou
  {
    ...
    imageUrl: getLocalFoodImage('suzhou-001'),
  ...
  },
  {
    ...
    imageUrl: getLocalFoodImage('suzhou-002'),
  ...
  // Lijiang
  {
    ...
    imageUrl: getLocalFoodImage('lijiang-001'),
  ...
  // Dali
  {
    ...
    imageUrl: getLocalFoodImage('dali-001'),
  ...
  // Yangshuo
  {
    ...
    imageUrl: getLocalFoodImage('yangshuo-001'),
