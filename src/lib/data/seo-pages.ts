...
export const chinaVisaGuideMeta: SeoPageMeta = {
  ...
  title: 'China Visa for NZ Citizens 2026 | CTS Tours',
  description: 'Complete China visa guide for New Zealand citizens in 2026. Learn requirements, processing times & application steps. Contact CTS Tours Auckland today.',
