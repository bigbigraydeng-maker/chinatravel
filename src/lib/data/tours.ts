...
export const tours: Tour[] = [
  ...
  {
  id: 'beijing-xian-shanghai-classic-china',
  slug: 'beijing-xian-shanghai-classic-china',
  destination: 'china',
  tier: 'discovery',
  name: 'China Discovery — Beijing, Xi\'an & Shanghai',
  title: 'Beijing, Xi\'an & Shanghai — Classic China Discovery',
  shortDescription: 'Explore China\'s greatest imperial treasures on this 12-day journey from Beijing\'s Forbidden City and Great Wall to Xi\'an\'s Terracotta Warriors and Shanghai\'s vibrant waterfront.',
  duration: '12 Days',
  ...
  itinerary: [
    ...
    },
    {
      day: 12,
      title: 'Arrive Auckland',
      description: 'Arrive at Auckland Airport at 16:25.',
      meals: [],
    },
  ],
  inclusions: [
  ...
  exclusions: [
    'Meals not listed in the itinerary (e.g. lunch on Day 11)',
    'Personal expenses',
    'Gratuities (not mentioned in document)',
  ],
  metaTitle: 'Classic China: Beijing, Xi\'an & Shanghai Tour',
  metaDescription: '12-day China tour from NZD $4,999. Discover the Great Wall, Forbidden City, Terracotta Warriors & Shanghai. All flights, 4-star hotels & meals included.',
  isActive: true,
  createdAt: '2026-08-24T11:28:02.452Z',
  updatedAt: '2026-08-24T11:28:02.452Z',
  tourCities: [
    'beijing',
    'xian',
    'shanghai',
