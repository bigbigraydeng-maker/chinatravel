...
export const tours: Tour[] = [
  // China Signature Tours
  {
    ...
    shortDescription: 'Journey along China\'s ancient Silk Road from Xi\'an to Urumqi across 18 days — exploring the Terracotta Warriors, Bingling Temple grottoes, colourful Danxia mountains, Mogao Caves, the Flaming Mountains, and Heavenly Lake.',
    duration: '18 Days',
    price: 'NZD $7,999',
    heroImage: 'https://qbturrydultenhlfmdcm.supabase.co/storage/v1/object/public/tour-images/tours/silk-road-wall/silk-road-wall.jpg',
    gallery: [
    ...
    itinerary: [
      ...
      { day: 6, title: 'Lanzhou — Bingling Temple', description: 'Take a boat trip across Liujiaxia Reservoir to the ancient Bingling Temple Grottoes, with over 1,700 years of Buddhist art carved into the cliffs.', meals: ['Breakfast', 'Lunch', 'Dinner'], accommodation: 'Wyndham Garden Lanzhou or similar 5-star' },
      { day: 7, title: 'Lanzhou — Wuwei', description: 'Visit the Yellow River Scenic Line for views of China\'s Mother River and a traditional Sanpaotai tea tasting, before travelling to Wuwei.', meals: ['Breakfast', 'Lunch', 'Dinner'], accommodation: 'Jinling Grand Hotel or similar 5-star' },
      { day: 8, title: 'Wuwei — Zhangye', description: 'Visit a local produce market, the Leitai Han Tomb and the Confucian Temple to explore the region\'s history and culture, then drive to Zhangye.', meals: ['Breakfast', 'Lunch', 'Dinner'], accommodation: 'Zhangye Hotel or similar 5-star' },
      { day: 9, title: 'Zhangye — Jiayuguan', description: 'Explore the spectacular Zhangye Rainbow Danxia National Geological Park and its colourful layered mountains, then continue to Jiayuguan for a traditional Fengyu carving experience.', meals: ['Breakfast', 'Lunch', 'Dinner'], accommodation: 'Jiayu Mingzhu Hotel or similar 5-star' },
      { day: 10, title: 'Jiayuguan — Dunhuang', description: 'Visit the dramatic Overhanging Great Wall and Jiayuguan Fortress, the western end of the Ming Dynasty Great Wall, before driving to Dunhuang for a local hot pot dinner.', meals: ['Breakfast', 'Lunch', 'Dinner'], accommodation: 'Tianhe Hotel or similar 5-star' },
      { day: 11, title: 'Dunhuang', description: 'Visit the world-renowned Mogao Grottoes and their exquisite Buddhist murals, try a Dunhuang mural painting experience, then explore Mingsha Mountain and Crescent Spring. Evening at leisure in the Dunhuang Night Market.', meals: ['Breakfast', 'Lunch'], accommodation: 'Tianhe Hotel or similar 5-star' },
      { day: 12, title: 'Dunhuang — Turpan', description: 'Visit the Dunhuang Solar Energy Exhibition Park, including the Molten Salt Tower, then travel to Liuyuan to board the bullet train to Turpan.', meals: ['Breakfast', 'Dinner'], accommodation: 'Hengze Hotel Turpan or similar 5-star' },
      { day: 13, title: 'Turpan', description: 'Visit the famous Flaming Mountains and the Bezeklik Thousand Buddha Caves with their ancient Buddhist mural art.', meals: ['Breakfast', 'Lunch', 'Dinner'], accommodation: 'Hengze Hotel Turpan or similar 5-star' },
      { day: 14, title: 'Turpan — Urumqi', description: 'Visit Emin Minaret, the ancient city ruins of Jiaohe, and the famous Karez irrigation system before continuing to Urumqi.', meals: ['Breakfast', 'Lunch', 'Dinner'], accommodation: 'Universal International Hotel Urumqi or similar 5-star' },
      { day: 15, title: 'Urumqi — Heavenly Lake', description: 'Visit beautiful Heavenly Lake in the Tianshan Mountains, including a relaxing boat cruise amid snow-capped peaks.', meals: ['Breakfast', 'Lunch', 'Dinner'], accommodation: 'Universal International Hotel Urumqi or similar 5-star' },
      { day: 16, title: 'Urumqi', description: 'Visit the Xinjiang Regional Museum, the Xinjiang Intangible Cultural Heritage Exhibition Park with a hands-on cultural experience, Hongshan Park, and the lively Grand Bazaar.', meals: ['Breakfast', 'Lunch', 'Dinner'], accommodation: 'Universal International Hotel Urumqi or similar 5-star' },
      { day: 17, title: 'Urumqi — Shanghai — New Zealand', description: 'Fly via Shanghai for your return flight to New Zealand.', meals: ['Breakfast'] },
      { day: 18, title: 'Arrive in New Zealand', description: 'Arrive back in New Zealand — your memorable Silk Road journey concludes.', meals: [] }
    ],
    inclusions: [
    ...
    metaTitle: 'China Signature — Silk Road | 18 Days | CTS Tours',
    metaDescription: 'Journey along China\'s ancient Silk Road — Terracotta Warriors, Danxia Mountains, Mogao Caves, Heavenly Lake. 18 days from NZD $7,999. Book with CTS Tours.',
    isActive: true,
  ...
  },
  {
    ...
    departureDates: ['15 March 2027', '3 September 2026'],
  ...
  // China Discovery — Fire & Fuzz (Chongqing + Chengdu)
  {
    ...
    departureDates: ['1 November 2026'],
...

  {
    ...
    destination: 'china',
    tier: 'discovery',
    name: 'China Discovery — Christmas & New Year in China',
    title: 'China Discovery — Christmas & New Year in China',
    ...
    highlights: [
      ...
      'Zhujiajiao Watertown, a pedi-cab Hutong tour with a local family visit and a Beijing Duck banquet',
      'Chongqing\'s Hongyadong night view, Ciqikou, Liziba and Eye in the Clouds, then Yum Cha in Guangzhou',
    ],
    itinerary: [
      {
        day: 1,
        title: 'Auckland — Guangzhou',
        description: 'Depart Auckland for Guangzhou on flight CZ 306, 2210/0510+1. Overnight on board.',
        meals: [],
      },
      {
        day: 2,
        title: 'Guangzhou — Shanghai',
        description: 'On arrival in Guangzhou you will clear immigration and customs, then transfer to your domestic flight CZ3533 0700/0915 to Shanghai. Upon arrival in Shanghai you will be met and greeted by our local representative, who will escort you to the hotel.',
        meals: [
          'Lunch',
          'Dinner',
        ],
      ...
      },
      {
        ...
        description: 'Transfer to the railway station to take the high-speed train to Beijing. Upon arrival, meet and greet, then private transfer to the hotel.',
        meals: [
          'Breakfast',
          'Dinner',
        ],
      ...
      },
      {
        day: 6,
        title: 'Beijing',
        description: 'Tour Tian\'anmen Square, the biggest public square in the world. You will also have a photo stop at the National Centre for the Performing Arts, formerly known as the National Grand Theatre and colloquially described as The Egg. Afterwards, visit the Forbidden City, the vast complex of palaces which was home to successive Emperors for more than 500 years; included is admission to the living quarters, museum and jewellery sections. Continue to Beihai Park, an imperial garden to the northwest of the Forbidden City. Tonight you will experience the famous Beijing Duck banquet for your welcome dinner.',
        meals: [
          'Breakfast',
          'Lunch',
          'Dinner',
      ...
      {
        day: 7,
        title: 'Beijing — Great Wall at Mutianyu',
        description: 'Morning tour to the Great Wall at the Mutianyu section, stretching almost 4,000 miles from the Pacific Ocean to the sands of Central Asia and befittingly crowned one of the ten wonders of the world.',
        meals: [
          'Breakfast',
          'Lunch',
          'Dinner',
      ...
      {
        day: 8,
        title: 'Beijing — Hutong & Summer Palace',
        description: 'This morning we enjoy a pedi-cab tour of the Hutong — the \'old city\' neighbourhoods of narrow alleyways and courtyard gardens — and experience local life on a family visit. After lunch, tour the Summer Palace, the largest and best preserved of all imperial palace gardens, which boasts such delights as the famous Marble Boat and the ornately painted \'Long Corridor\', and take a boat ride on Lake Kunming if the weather permits.',
        meals: [
          'Breakfast',
          'Lunch',
          'Dinner',
      ...
      },
      {
        day: 9,
        title: 'Beijing — Xi\'an',
        description: 'Transfer to the railway station to take the high-speed train to Xi\'an. Upon arrival, meet and greet, then private transfer to the hotel.',
        meals: [
          'Breakfast',
          'Dinner',
        ],
      ...
      {
        day: 11,
        title: 'Xi\'an — City Wall & Muslim Quarter',
        description: 'Visit the Xi\'an City Wall, a well-preserved ancient city rampart encircling central Xi\'an, where visitors may walk or cycle on top for old-town views. Continue to the Yongxingfang Food Block with bowl-smashing wine — a folk-themed food precinct with authentic Shaanxi snacks, where bowl-smashing wine is a symbolic local ritual for blessings. Then Bell & Drum Tower Square, home to the historic Bell and Drum Towers; bustling Muslim Street, offering Hui-flavoured street food; and the Great Mosque of Xi\'an, which features a unique mix of Chinese and Islamic architectural styles.',
        meals: [
          'Breakfast',
          'Lunch',
          'Dinner',
      ...
      },
      {
        ...
        description: 'Transfer to the railway station to take the train to Chongqing. Upon arrival, meet and greet, visit the Hongyadong night view, then private transfer to the hotel.',
        meals: [
          'Breakfast',
          'Dinner',
        ],
      ...
      },
      {
        day: 13,
        title: 'Chongqing',
        description: 'Visit Ciqikou, Liziba, Kuixing Tower, Jiefangbei and Eye in the Clouds.',
        meals: [
          'Breakfast',
          'Lunch',
          'Dinner',
      ...
      {
        day: 14,
        title: 'Chongqing — Guangzhou',
        description: 'Transfer to the airport to take flight CZ3426 1715/1915 to Guangzhou. Upon arrival, meet and greet, then free shopping until the transfer to the airport.',
        meals: [
          'Breakfast',
        ],
      ...
      {
        day: 15,
        title: 'Guangzhou — Departure',
        description: 'Enjoy an authentic Yum Cha in the birthplace of Yum Cha, Guangzhou, in the late morning, before you are taken to the airport for your outward flight CZ335 1430/0630+1.',
        meals: [],
      },
      {
        day: 16,
        title: 'Auckland',
        description: 'Arrive in Auckland.',
        meals: [],
      },
    ],
    inclusions: [
      ...
      '2nd class train tickets as per the itinerary',
    ],
    exclusions: [
      'China visa (if applicable at time of travel)',
      'Travel insurance',
      'Personal expenses',
      'Tips for guides and drivers (NZD 10 per person per day)',
    ],
    metaTitle: 'Christmas & New Year in China 16 Days | CTS Tours',
    metaDescription: 'Celebrate Christmas in Shanghai and New Year\'s Eve in ancient Xi\'an on a 16-day China tour: Great Wall, Forbidden City, Terracotta Warriors, Chongqing and Guangzhou.',
    isActive: true,
  ...
  {
    id: 'tour-cn-dis-9',
    slug: 'china-icons-collection-christchurch',
    destination: 'china',
    tier: 'discovery',
    name: 'China Discovery — Christmas & New Year in China (Christchurch Departure)',
    ...
    highlights: [
      ...
      'The 2,000-year-old Terracotta Warriors, including the Circle Vision Movie and Bronze Chariot',
      'Zhujiajiao Watertown, a pedi-cab Hutong tour with a local family visit and a Beijing Duck banquet',
      'Chongqing\'s Hongyadong night view, Ciqikou, Liziba and Eye in the Clouds',
    ],
    itinerary: [
      {
        day: 1,
      ...
      {
        day: 15,
        title: 'Arrive in Christchurch',
        description: 'Arrive back in Christchurch — your festive China journey concludes.',
        meals: [],
      },
    ],
    inclusions: [
    ...
    metaTitle: 'Christmas & New Year in China — Christchurch Departure | CTS Tours',
    metaDescription: 'A 15-day South Island departure: Christmas in Shanghai, New Year\'s Eve in Xi\'an, the Great Wall, Forbidden City and Terracotta Warriors — flying direct ex-Christchurch via Guangzhou.',
    isActive: true,
  ...
  },
  {
    ...
    title: 'China Discovery — Golden China',
    shortDescription: 'Trace the golden thread of China\'s imperial history on this 12-day journey through Beijing\'s Forbidden City and Great Wall, Xi\'an\'s Terracotta Warriors, and Shanghai\'s vibrant waterfront.',
    duration: '12 Days',
    ...
    highlights: [
      ...
      'Discover the 2,000-year-old Terracotta Warriors of Xi\'an',
      'Explore the vast Forbidden City and Tiananmen Square',
      'Evening cruise along Shanghai\'s Huangpu River',
      'Hutong pedi-cab tour and family visit in old Beijing',
      'Stroll the ancient water town of Zhujiajiao',
    ],
    itinerary: [
      {
        day: 1,
        title: 'Auckland — Shanghai',
        description: 'Depart Auckland on flight MU780 at 22:00. Meals are served on board.',
        meals: [],
      },
      {
        day: 2,
        title: 'Shanghai — Beijing',
        description: 'Upon arrival in Shanghai, clear immigration and customs and transfer to the domestic terminal for flight MU5151 (08:00–10:25) to Beijing. Met and greeted by your local representative at the airport. Transfer to visit the Temple of Heaven, the 500-year-old temple housing altars on which sacrifices and offerings were laid to the gods, set in glorious gardens, trees and sculptures. Stroll along Qianmen Street. Tonight enjoy the famous Beijing Duck banquet as your welcome dinner.',
        meals: [
          'Lunch',
          'Dinner',
        ],
      ...
      },
      {
        day: 3,
        title: 'Beijing',
        description: 'Tour Tiananmen Square, the biggest public square in the world. Afterwards, visit the Forbidden City, the vast complex of palaces which was home to successive Emperors for more than 500 years. Continue to visit Beihai Park, an imperial garden to the northwest of the Forbidden City. Note: there is a daily limit on the number of tickets available for the Forbidden City; entry cannot be guaranteed and is subject to availability. If tickets cannot be secured, a visit to Jingshan Park overlooking the Forbidden City and Prince Gong\'s Mansion will be offered instead.',
        meals: [
          'Breakfast',
          'Lunch',
          'Dinner',
      ...
      },
      {
        day: 4,
        title: 'Beijing',
        description: 'Morning tour to the Great Wall at Juyongguan section, stretching almost 4,000 miles and crowned one of the ten wonders of the world. Return to the city to view the Olympic Park\'s Bird\'s Nest and Water Cube from the outside.',
        meals: [
          'Breakfast',
          'Lunch',
          'Dinner',
      ...
      },
      {
        day: 5,
        title: 'Beijing',
        description: 'Morning pedi-cab tour of Hutong — the \'old city\' neighbourhoods of narrow alleyways and courtyard gardens — and a local family visit. After lunch, tour the Summer Palace, the largest and best-preserved of all imperial palace gardens, featuring the famous Marble Boat and the ornately painted \'Long Corridor\'.',
        meals: [
          'Breakfast',
          'Lunch',
          'Dinner',
      ...
      },
      {
        day: 6,
        title: 'Beijing — Xi\'an',
        description: 'Morning free at leisure. Board train G655 (08:26–14:20) to Xi\'an in 2nd-class seat. Met on arrival by the local guide and transferred to the hotel to rest. In the evening stroll through Hui Min Street and Zhonggu Lou Square.',
        meals: [
          'Breakfast',
          'Dinner',
        ],
        accommodation: 'Mercure Downtown Xi\'an or similar (4-star)',
      },
      {
        day: 7,
        title: 'Xi\'an',
        description: 'Morning tour to the greatest archaeological discovery of the century — the more than 2,000-year-old Terracotta Warriors interred with Emperor Qin Shi Huang, including the Bronze Chariot exhibit. In the evening enjoy a Xi\'an dumpling dinner with Tang Dynasty dance performances.',
        meals: [
          'Breakfast',
          'Lunch',
          'Dinner',
      ...
      },
      {
        ...
        description: 'Morning visit to the Old City Wall and Big Wild Goose Pagoda, the earliest and largest existing square pavilion-style brick pagoda of the Tang Dynasty and a testament to the integration of ancient Indian Buddhist temple architecture into Chinese culture. After lunch, transfer to the airport for domestic flight MU2161 (16:00–18:20) to Shanghai. Met on arrival by the local representative. After dinner, escorted to the hotel for check-in.',
        meals: [
          'Breakfast',
          'Lunch',
          'Dinner',
        ],
        accommodation: 'Motorpark Jichen Hotel Shanghai (4-star)',
      },
      {
        day: 9,
        title: 'Shanghai',
        description: 'Morning visit to the water town of Zhujiajiao. Afternoon return to downtown Shanghai, free at leisure. After dinner, enjoy an evening cruise along the Huangpu River to admire the charming night views on both river banks.',
        meals: [
          'Breakfast',
          'Dinner',
        ],
      ...
      },
      {
        day: 10,
        title: 'Shanghai',
        description: 'Morning visit to the elegant and tranquil Yu Garden, believed to have been built more than 400 years ago, whose exquisite architecture makes it one of the highlights of Shanghai. In the afternoon, visit Shanghai Museum (East), the Bund, and Nanjing Road for shopping.',
        meals: [
          'Breakfast',
          'Lunch',
          'Dinner',
      ...
      },
      {
        day: 11,
        title: 'Shanghai',
        description: 'Free at leisure until after lunch (lunch not included). Picked up from the hotel to visit Xintiandi — a polished commercial version of Shanghai\'s Stone-Gate architecture known for its upscale, cosmopolitan vibe. Then explore Tianzifang, a warren of narrow alleyways packed with boutique galleries, quirky design shops, cozy cafes and local craft stalls. In the evening, transfer to Pudong International Airport for your overnight departure.',
        meals: [
          'Breakfast',
          'Dinner',
        ],
      },
      {
        ...
        description: 'Depart Shanghai on flight MU779 at 00:10, arriving in Auckland at 16:25.',
        meals: [],
      },
    ],
    inclusions: [
      ...
      'English-speaking guide',
      'Land transportation',
      'Admission to sightseeing places as per the itinerary',
      '2nd-class high-speed train from Beijing to Xi\'an',
    ],
    exclusions: [
      'Travel insurance (strongly recommended)',
      'Personal expenses',
  ...
  // 2) price and departure date(s) were not supplied; 3) isActive is false until both are confirmed.
  {
    ...
    destination: 'china',
    tier: 'discovery',
    name: 'China Discovery — Natural China',
    ...
    highlights: [
      'A 3-night Yangtze River cruise through the Three Gorges, from Yichang to Chongqing',
      'Shanghai\'s Yuyuan Garden, the Bund, Nanjing Road and a Huangpu River night cruise',
      'Chongqing\'s Liziba Monorail Station, Jiefangbei, Ciqikou Ancient Town and Hongyadong night views',
      'The Chengdu Research Base of Giant Panda Breeding',
      'Zhangjiajie National Forest Park, the Bailong Elevator and Tianmen Mountain\'s Glass Skywalk',
      'High-speed rail travel between Chongqing–Chengdu and Chengdu–Zhangjiajie',
    ],
    itinerary: [
      {
        day: 1,
        title: 'Auckland — Fly to Shanghai',
        description: 'Depart for Shanghai.',
        meals: [],
      },
      {
        day: 2,
        title: 'Arrive in Shanghai',
        description: 'Arrive in Shanghai in the morning. Meet your guide and visit Chenghuang Temple and Yuyuan Garden, Nanjing Road, The Bund, Xintiandi and Tianzifang, and the traditional Shikumen area.',
        meals: ['Lunch', 'Dinner'],
        accommodation: 'Hyatt Place Shanghai Changfeng or similar 5-star hotel',
      },
      {
        day: 3,
        title: 'Shanghai',
        description: 'After breakfast, visit Jade Buddha Temple, followed by the Oriental Pearl Radio & TV Tower and the Shanghai Museum East. In the evening, enjoy a night cruise along the Huangpu River.',
        meals: ['Breakfast', 'Lunch', 'Dinner'],
        accommodation: 'Hyatt Place Shanghai Changfeng or similar 5-star hotel',
      },
      {
        day: 4,
        title: 'Shanghai — Yichang',
        description: 'Enjoy some free time in Shanghai in the morning. After lunch, transfer to the airport for the flight to Yichang. Upon arrival, meet your local guide and transfer for dinner. After dinner, board the Three Gorges cruise ship.',
        meals: ['Breakfast', 'Lunch', 'Dinner'],
        accommodation: 'Three Gorges cruise ship',
      },
      {
        day: 5,
        title: 'Three Gorges Cruise',
        description: 'Enjoy the Three Gorges cruise.',
        meals: ['Breakfast', 'Lunch', 'Dinner'],
        accommodation: 'Three Gorges cruise ship',
      },
      {
        day: 6,
        title: 'Three Gorges Cruise',
        description: 'Continue the Three Gorges cruise.',
        meals: ['Breakfast', 'Lunch', 'Dinner'],
        accommodation: 'Three Gorges cruise ship',
      },
      {
      ...
      {
        day: 8,
        title: 'Arrive in Chongqing',
        description: 'Disembark from the cruise and meet your guide. Visit Liziba Monorail Station, where the light rail passes through a residential building, followed by Jiefangbei and Ciqikou Ancient Town. After dinner, enjoy an exterior view of Hongyadong and its spectacular night scenery.',
        meals: ['Breakfast', 'Lunch', 'Dinner'],
        accommodation: 'Four Points by Sheraton Chongqing',
      },
      {
        day: 9,
        title: 'Chongqing — Chengdu by High-Speed Train',
        description: 'After breakfast, transfer to the railway station and take a high-speed train to Chengdu (reference train: Chongqing North → Chengdu East, G8610, 09:32–10:58, First Class, or a similar service). Upon arrival in Chengdu, meet your guide. After lunch, visit Wuhou Shrine and Jinli Ancient Street.',
        meals: ['Breakfast', 'Lunch', 'Dinner'],
        accommodation: 'Holiday Inn Chengdu Oriental Plaza or similar 5-star hotel',
      },
      {
        day: 10,
        title: 'Chengdu',
        description: 'After breakfast, visit the Chengdu Research Base of Giant Panda Breeding. Continue to People\'s Park, where you can experience the local tradition of enjoying tea, followed by Taikoo Li and Kuanzhai Alley. Optional evening excursion: Sichuan Opera face-changing performance.',
        meals: ['Breakfast', 'Lunch', 'Dinner'],
        accommodation: 'Holiday Inn Chengdu Oriental Plaza or similar 5-star hotel',
      },
      {
        day: 11,
        title: 'Chengdu — Zhangjiajie — Wulingyuan',
        description: 'After breakfast, transfer to Chengdu East Railway Station and take a high-speed train to Zhangjiajie (reference train: Chengdu East → Zhangjiajie West, G2321, 10:20–15:27, First Class, or a similar service). Upon arrival, meet your guide and transfer to Wulingyuan. After dinner, check in at the hotel.',
        meals: ['Breakfast', 'Dinner'],
        accommodation: 'Wulingyuan Rêverie Mansen Wyndham Hotel or similar 5-star hotel',
      },
      {
        day: 12,
        title: 'Wulingyuan',
        description: 'After breakfast, visit Zhangjiajie National Forest Park. Take the Bailong Elevator up and the Tianzi Mountain Cableway down, visiting Yuanjiajie, West Sea Stone Forest, and the landscapes associated with Hallelujah Mountain. Continue to Ten-Mile Gallery, including a sightseeing mini-train ride.',
        meals: ['Breakfast', 'Lunch', 'Dinner'],
        accommodation: 'Wulingyuan Rêverie Mansen Wyndham Hotel or similar 5-star hotel',
      },
      {
        ...
        description: 'After breakfast, visit Tianmen Mountain National Forest Park, including the cable car, an eco-friendly sightseeing shuttle, a one-way escalator through Tianmen Cave, the Glass Skywalk (shoe covers included) and the Guigu Plank Walk. Continue to Tujia Folk Customs Park. Transfer to the airport and fly to Shanghai (reference flight: Zhangjiajie T2 → Shanghai Pudong T2, HO1136, 16:25–18:30). Upon arrival, meet your guide and transfer for dinner, followed by hotel check-in.',
        meals: ['Breakfast', 'Lunch', 'Dinner'],
        accommodation: 'Hyatt Place Shanghai Changfeng or similar 5-star hotel',
      },
      {
    ...
    inclusions: [
      'International and domestic flights as per the itinerary',
      '5-star hotel accommodation throughout (or similar)',
      'Meals as per the itinerary',
      'English-speaking guide',
      'Land transportation',
      'Admission to sightseeing places as per the itinerary',
      '3-night Three Gorges cruise (Yichang to Chongqing)',
      'First-class high-speed train, Chongqing–Chengdu and Chengdu–Zhangjiajie',
    ],
    exclusions: [
      'Travel insurance (strongly recommended)',
      'Personal expenses',
      'Transportation and guide services during free time',
      'Meals not listed in the itinerary',
      'Optional Sichuan Opera face-changing performance (Chengdu)',
      'Tips (suggested NZD $10 per day per person)',
      'Any items not specifically mentioned as included in the itinerary',
    ],
    ...
    quickAnswer:
      'Natural China is a 14-day CTS Tours itinerary departing Auckland for Shanghai, with a 3-night Yangtze River cruise through the Three Gorges from Yichang to Chongqing, then high-speed rail to Chengdu (Giant Panda Base) and on to Zhangjiajie/Wulingyuan (Tianmen Mountain\'s Glass Skywalk, Zhangjiajie National Forest Park) before returning via Shanghai to Auckland. Price and confirmed departure dates are pending.',
    faqs: [
      {
        question: 'Does the Natural China tour include a Yangtze River cruise?',
        answer: 'Yes. The itinerary includes a 3-night Three Gorges cruise from Yichang to Chongqing, followed by a full day exploring Chongqing before travelling on by high-speed train.',
      },
      {
        question: 'Which cities does the Natural China tour visit?',
        answer: 'Shanghai, the Three Gorges (Yichang to Chongqing) by river cruise, Chongqing, Chengdu, and Zhangjiajie/Wulingyuan, before returning through Shanghai to Auckland.',
      },
      {
        question: 'How much does the Natural China tour cost and when does it depart?',
        answer: 'Pricing and confirmed departure dates for this tour have not been published yet — enquire with the CTS Tours team for the latest availability.',
      },
    ],
  }
];
